...
require_once(ABSPATH."wp-content/plugins/sms-text-message/options.php");
require_once(ABSPATH."wp-content/plugins/sms-text-message/database.php");
require_once(ABSPATH."wp-content/plugins/sms-text-message/support.php");
require_once(ABSPATH."wp-content/plugins/sms-text-message/functions.php");
require_once(ABSPATH."wp-content/plugins/sms-text-message/subscribers.php");
require_once(ABSPATH."wp-content/plugins/sms-text-message/update.php");
require_once(ABSPATH."wp-content/plugins/sms-text-message/simplepie.inc");
...
function mrt_add_menu() {
   add_menu_page('SMS Text Message', 'SMS Text Message', 8, __FILE__, 'mrt_sms_main_control',get_option('siteurl') . '/wp-content/plugins/sms-text-message/sms-text-message.png');
