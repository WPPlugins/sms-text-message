...
echo '<script src="' . get_option("siteurl") . '/wp-content/plugins/sms-text-message/scripts.js"></script>';
echo '<script src="' . get_option("siteurl") . '/wp-content/plugins/sms-text-message/sorttable.js"></script>';
